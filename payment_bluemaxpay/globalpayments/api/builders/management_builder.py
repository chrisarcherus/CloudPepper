...
from odoo.addons.payment_bluemaxpay.globalpayments.api.builders import TransactionBuilder
from odoo.addons.payment_bluemaxpay.globalpayments.api.entities.enums import TransactionModifier, TransactionType
