...
from odoo.addons.pos_card_present.globalpayments.api.builders import TransactionBuilder
from odoo.addons.pos_card_present.globalpayments.api.entities.enums import TransactionModifier, TransactionType
