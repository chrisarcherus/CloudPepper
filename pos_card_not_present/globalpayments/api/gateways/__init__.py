...
import re
import certifi
from odoo.addons.pos_card_not_present.globalpayments import jsonpickle
import urllib3.contrib.pyopenssl
from odoo.addons.pos_card_not_present.globalpayments.api.gateways import xmltodict
from odoo.addons.pos_card_not_present import globalpayments as gp
import datetime
import pkg_resources
from odoo.addons.pos_card_not_present.globalpayments.api.entities import (
    Address, BatchSummary, Customer, DebitMac, RecurringPaymentMethod,
    Schedule, ThreeDSecure, Transaction, TransactionSummary)
from odoo.addons.pos_card_not_present.globalpayments.api.entities.enums import (
...
from odoo.addons.pos_card_not_present.globalpayments.api.entities.exceptions import (
    ApiException, BuilderException, GatewayException,
    UnsupportedTransactionException)
from odoo.addons.pos_card_not_present.globalpayments.api.gateways.gateway_response import GatewayResponse
from odoo.addons.pos_card_not_present.globalpayments.api.gateways.table_service_connector import TableServiceConnector
from odoo.addons.pos_card_not_present.globalpayments.api.payment_methods import (
...
from odoo.addons.pos_card_not_present.globalpayments.api.utils import GenerationUtils
