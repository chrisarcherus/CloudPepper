from odoo.addons.pos_card_not_present.globalpayments import api
from odoo.addons.pos_card_not_present.globalpayments.api.builders.validations.validation_clause import ValidationClause
