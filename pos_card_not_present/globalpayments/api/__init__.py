...
from odoo.addons.pos_card_not_present.globalpayments.api.entities.exceptions import ConfigurationException
from odoo.addons.pos_card_not_present.globalpayments.api.gateways import (
