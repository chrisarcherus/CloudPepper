...
import { PaymentCardNotPresent } from "@pos_card_not_present/js/payment_card_not_present";
import { SavedCards } from "@pos_card_not_present/js/payment_saved_cards";

register_payment_method('card_not_present', PaymentCardNotPresent);
register_payment_method('savedcards', SavedCards);
