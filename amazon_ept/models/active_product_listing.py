...
class ActiveProductListingReportEpt(models.Model):
    ...
    report_id = fields.Char('Report ID', readonly=True, help='ID of report')
    ...
    def create_amazon_report_attachment(self, result):
        ...
        self.message_post(body=_("Active Product Report Downloaded"), attachment_ids=attachment.ids)
