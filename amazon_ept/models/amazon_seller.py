...
class AmazonSellerEpt(models.Model):
    ...
    amz_activity_user_ids = fields.Many2many('res.users', 'res_users_amazon_seller_rel',
                                             'seller_id', 'res_users_id', string='Responsible User (Amazon)')
    ...
    def amz_search_or_create_analytic_account_plan(self):
        ...
        analytic_account_plan = analytic_account_plan_obj.search([('name', '=', 'Amazon')], limit=1)
    ...
    # commented below both methods because import and process FBM unshipped orders report is deprecated in v17
    ...
    def auto_process_missing_unshipped_sale_order_ept(self, args={}):
        ...
        if seller_id:
            seller = self.browse(int(seller_id))
            sale_order_obj.import_fbm_shipped_or_missing_unshipped_orders(
