...
class ShippingReportRequestHistory(models.Model):
    ...
    def create_amazon_report_attachment(self, result):
        ...
        self.message_post(body=_("Shipment Report Downloaded"), attachment_ids=attachment.ids)
    ...
    def check_amz_instance_and_shipment(self, row, instance, order_dict):
        ...
        if not instance:
            ...
            is_mismatch_detail = self.amz_get_is_mismatch_details_for_outbound()
            log_line_obj.create_common_log_line_ept(
                ...
                operation_type='import', res_id=self.id, mismatch_details=is_mismatch_detail, amz_seller_ept=instance.seller_id and
    ...
    def search_amazon_outbound_order_ept(self, order_ref):
        ...
        if not amazon_order:
            ...
            common_log_line_obj.create_common_log_line_ept(
                ...
                mismatch_details=is_mismatch_detail, amz_seller_ept=self.seller_id and self.seller_id.id or False)
            return amazon_order
    ...
    def prepare_outbound_stock_move_line_vals(product, picking, shipped_qty, stock_move):
        ...
        return {
            ...
            'quantity': float(shipped_qty) or 0,
    ...
    def amz_get_is_mismatch_details_for_outbound(self):
        """
        Define this method for check mismatch details for outbound order.
        :return: True/False
        """
        return True if self.seller_id.allow_auto_create_outbound_orders else False
