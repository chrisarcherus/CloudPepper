...
class VcsTaxReport(models.Model):
    ...
    def create(self, vals_list):
        ...
        :return: amazon.vcs.tax.report.ept()
        """
    ...
    def create_amazon_report_attachment(self, result):
        ...
        if result:
            ...
            self.message_post(body=_("VCS Tax Report Downloaded"), attachment_ids=attachment.ids)
    ...
    def check_amazon_vcs_required_records(self, row, amazon_seller, country_dict, instance_dict, ship_from_country_dict,
        ...
        :return: str, sale.order(), amazon.instance.ept()
        """
        ...
        if not instance:
            ...
            return message, False, False
        sale_order = self.find_amazon_vcs_sale_order_ept(
            row, instance, ship_from_country_dict, warehouse_country_dict)
        if not sale_order:
    ...
    @staticmethod
    def process_vcs_report_data_ept(row, sale_order, product_id, vcs_invoice_ids, transaction_line_ids):
        """
    ...
    @staticmethod
    def check_vcs_report_file_data_ept(row, line_no):
        """
        This method will check the required data exist to process for update taxes in
    ...
    def find_vcs_country_ept(self, country_dict, marketplace_id):
        """
        This method wil find the country based on amazon_marketplace_code and also update the country dict.
    ...
    def find_amazon_vcs_product_ept(self, amazon_prod_dict, sku, instance, fulfillment_by):
        """
        This method will fine tha amazon product based on instance, sku and fulfillment_by and
         update the amazon product dict.
