...
class AmazonConfigSettings(models.TransientModel):
    ...
    def onchange_amz_instance_id(self):
        ...
        if instance:
            ...
            values[
                ...
                instance.market_place_id == 'ATVPDKIKX0DER' else False
            values[
    ...
    def open_operations_tutorial(self):
        ...
        url = Markup('<iframe width="920px" height="520px" src="https://www.youtube.com/embed/%s?autoplay=1" '
                     'title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" '
                     'frameborder="0" allowFullScreen="true"></iframe>'
                     ) % (video_tutorial.get(self._context.get("tutorial_type")))
        action['context'] = {'default_amz_video_url': url}
        action['name'] = self._context.get('tutorial_type')
        return action

    def document_open(self):
        document_url = {'register_seller':
                            "https://docs.emiprotechnologies.com/amazon-odoo-connector/v15/seller-registration.html",
                        'connect_your_seller':
                            "https://docs.emiprotechnologies.com/amazon-odoo-connector/v15/seller-registration.html",
                        'vat_number_configuration':
                            "https://docs.emiprotechnologies.com/amazon-odoo-connector/v15/vat-number-registration.html"
                        }
