...
from odoo.addons.payment_card_present.globalpayments.api.entities.exceptions import ConfigurationException
from odoo.addons.payment_card_present.globalpayments.api.gateways import (
