...
from odoo.addons.payment_card_present.globalpayments.api.builders import TransactionBuilder
from odoo.addons.payment_card_present.globalpayments.api.entities.enums import TransactionModifier, TransactionType
