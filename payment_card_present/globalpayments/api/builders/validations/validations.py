from odoo.addons.payment_card_present.globalpayments import api
from odoo.addons.payment_card_present.globalpayments.api.builders.validations.validation_target import ValidationTarget
